...
public class MapaUsuariosTipoSangre extends AppCompatActivity {
    String Respuesta="";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mapa_usuarios_tipo_sangre);
      ...
      //  setSupportActionBar(toolbar);
        ...
        setUpMapIfNeeded();
        String cadenaDispo=fila2.charAt(1)+"";
        if(cadenaDispo.equals("N")){
            cadenaDispo="No disponible";
        }
        else if(cadenaDispo.equals("S")){
            cadenaDispo="Disponible";
        }

        String cadenasexo=fila2.charAt(0)+"";
        if(cadenasexo.equals("F")){
            cadenasexo="Mujer";
            fila2=cadenasexo+"\t"+cadenaDispo;
            setMarker(new LatLng(coorcamaraX, coorcamaraY), fila,
                    fila2 , 0.5F, 0.5F, 0.5F, R.drawable.mujer);
        }
        else if(cadenasexo.equals("M")){
            cadenasexo="Hombre";
            fila2=cadenasexo+"\t"+cadenaDispo;
            setMarker(new LatLng(coorcamaraX, coorcamaraY), fila,
                    fila2 , 0.5F, 0.5F, 0.5F, R.drawable.hombre);
        }
